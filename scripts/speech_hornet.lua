return {
	ACTIONFAIL =
	{
        ...
        BUILD =
        {
            MOUNTED = "I'm too high up to reach that that.", --Customised
            HASPET = "I won't abandon my pet for another.", --Customised
        },
		SHAVE =
		{
			AWAKEBEEFALO = "Shaving the beast will not be possible while it's awake.", --Customised
			GENERIC = "I can't shave that!",
			NOBITS = "There is nothing left to shave.",
            REFUSE = "only_used_by_woodie",
            SOMEONEELSESBEEFALO = "This beast does not belong to me.",
		},
		STORE =
		{
        ...
        COOK =
        {
            GENERIC = "This is not the time for cooking.",
            INUSE = "That's already in use.",
        ...
        GIVE =
        {
            ...
            DUPLICATE = "There is nothing more I can learn from this.",
        ...
        GIVETOPLAYER =
        {
            FULL = "This would be more than you can carry.", --Customised
            DEAD = "This would be wasted on this one.", --Customised
            SLEEPING = "I'll give them this when they wake.",
            BUSY = "I'll wait till they're done.",
        },
        GIVEALLTOPLAYER =
        {
            FULL = "This would be more than you can carry.",
            DEAD = "This would be wasted on this one.",
            SLEEPING = "I'll give them this when they wake.",
            BUSY = "I'll wait till they're done.",
        },
        WRITE =
        {
            ...
            INUSE = "I should exercise patience.", --Customised
        },
        DRAW =
        {
            NOIMAGE = "Without a reference, I don't have the skill.", --Customised
        },
        CHANGEIN =
        {
        ...
        PICKUP =
        {
			RESTRICTION = "I don't know what to do with that.",
			INUSE = "Science says I have to wait my turn.",
        ...
        SLAUGHTER =
        {
            TOOFAR = "It appears to have escaped me.",
        },
        REPLATE =
        {
	...
	ANNOUNCE_CHARLIE = "The shadows come for me.", --Customised
	ANNOUNCE_CHARLIE_ATTACK = "Vicious shade.", --Customised
	...
	ANNOUNCE_DEERCLOPS = "I sense my next challenge approaching. Will I have the strength to see it through?", --Customised
	ANNOUNCE_CAVEIN = "What beast could cause that?", --Customised
	ANNOUNCE_ANTLION_SINKHOLE =
	{
		"What beast could cause that?", --Customised
		"I should seek out the cause...", --Customised
	},
	ANNOUNCE_ANTLION_TRIBUTE =
	{
        "Allow me to pay tribute.",
        "My pride as a warrior may suffer, but the beast is pacified.", --Customised
        "The beast is sated, for now at least...", --Customised
	},
	ANNOUNCE_SACREDCHEST_YES = "I guess I'm worthy.",
	ANNOUNCE_SACREDCHEST_NO = "It didn't like that.",
    ANNOUNCE_DUSK = "Darkness approaches. I should prepare.",
	...
	ANNOUNCE_ENTER_DARK = "I must escape this darkness!", --Customised
	ANNOUNCE_ENTER_LIGHT = "I can see again!",
	ANNOUNCE_FREEDOM = "I'm free! I'm finally free!",
	ANNOUNCE_HIGHRESEARCH = "I feel so smart now!",
	ANNOUNCE_HOUNDS = "I sense an my next trial is near.", --Customised
	ANNOUNCE_WORMS = "Did you feel that?",
	ANNOUNCE_HUNGRY = "I'm so hungry!",
	ANNOUNCE_HUNT_BEAST_NEARBY = "This track is fresh. The beast must be nearby.", --Customised
	ANNOUNCE_HUNT_LOST_TRAIL = "The beast's trail ends here.", --Customised
	...
	ANNOUNCE_MOSQUITOS = "Perhaps a relative of my homeland's vengeflies?", --rewrite later
    ANNOUNCE_NOWARDROBEONFIRE = "If it weren't on fire perhaps...",
    ANNOUNCE_NODANGERGIFT = "I can't let my focus slip now.",
	...
	COMBAT_QUIT =
	{
		GENERIC = "We can put downs our weapons, at least for now", --improve later
		PIG = "I need not spill further blood in this moment.",
		PREY = "He's too fast!",
		SPIDER = "I need not spill the blood of my kin.",
		SPIDER_WARRIOR = "I need not spill the blood of my kin.",
	},

	DESCRIBE =
	{
		MULTIPLAYER_PORTAL = "The door that brought me to this forsaken land.", --Customised
        MULTIPLAYER_PORTAL_MOONROCK = "The door that brought me to this forsaken land, though it has been altered.", --Customised
        MOONROCKIDOL = "I will not worship this false idol.", --Customised?
        CONSTRUCTION_PLANS = "Stuff for science!", 

        ANTLION =
        {
            GENERIC = "Should I appease this beast, or face it head on?", --Customised
            VERYHAPPY = "This beast seems to favour me for now...", --Customised
            UNHAPPY = "A foul beast in a foul mood.", --Customised
        },
        ...
        WILSON = --finished, could use work
        {
            ...
            ATTACKER = "%s, would you slay another?",
            MURDERER = "Did you find your answers in this act, %s.",
            REVIVER = "%s, you would allow me another chance?",
            GHOST = "%s, only pity for your cursed kind.",
        ...
        WOLFGANG = --almost finished, could use work
        {
            ...
            MURDERER = "You would use your strength to slay another? I am not so weak.",
            REVIVER = "%s, you would allow me another chance?",
        ...
        WALTER = --finished
        {
            ...
            MURDERER = "This child is dangerous, I can't allow him to continue.",
            REVIVER = "Child, I am grateful for the second chance.",
            GHOST = "So young... Can I change his fate?",
        ...
        WANDA = --barely started
        {
            ...
            GHOST = "Despite your tinkering, you could not defy fate.",
            FIRESTARTER = "All that tinkering, yet you still resort to flames.",
        },
        ...
        GUANO = "Disgusting, but not without it's uses.",
        LANTERN = "A portable lampost to light the shadows.",
        ...
        TOADSTOOL =
        {
            GENERIC = "Has the infection spread even to here?",
		...
		ARMORWOOD = "The best protection I can find, at least for now.",
		...
		CHESTER = "A friendly, though disconcerting, beast.",
		CHESTER_EYEBONE =
		{
		...
		COOKPOT =
		{
			COOKING_LONG = "With time, this will sustain me.",
			COOKING_SHORT = "It's almost ready.",
			DONE = "This should sustain me for now.",
			EMPTY = "This should make my ingredients go further.",
			BURNT = "Consumed by flames, this is no longer functional..",
		},
		...
		FLINT = "Weak, but plentiful.",
		FLOWER =
		{
            GENERIC = "Beautiful, though not like the flowers of my homeland.",
            ROSE = "A sharp little flower.",
        },
		...
		GEARS = "Small parts that can perhaps be part of a greater whole.",
		GHOST = "The dead do not rest easy in this land.",
		...
		GRASSGEKKO =
		{
			GENERIC = "What a bizzare creature.",
		...
		HAMBAT = "Not my needle, but it will do.",
		...
		HOUND = "A dangerous beast when with it's pack.",
		HOUNDCORPSE =
		{
        ...
        MARBLE = "A stronger material than most I've found.",
        MARBLEBEAN = "This is unnatural.",
		...
		WARG = "A terrible beast, I will remove you from this plane.",
